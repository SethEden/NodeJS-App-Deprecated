...
var initClientRulesLibrary = function initClientRulesLibrary() {
  ...
  return _ref = {}, _defineProperty(_ref, c.cclientEcho, function (inputData, inputMetaData) {
    return inputData, inputMetaData;
  }), _defineProperty(_ref, c.ccustomEcho, function (inputData, inputMetaData) {
    return clientStringParsing.customEcho(inputData, inputMetaData);
  }), _defineProperty(_ref, c.cmostPopularNumber, function (inputData, inputMetaData) {
    return clientStringParsing.mostPopularNumber(inputData, inputMetaData);
  }), _defineProperty(_ref, c.cisAlmostPalindrome, function (inputData, inputMetaData) {
    return clientStringParsing.isAlmostPalindrome(inputData, inputMetaData);
  }), _defineProperty(_ref, c.cthreePointAverage, function (inputData, inputMetaData) {
    return clientStringParsing.threePointAverage(inputData, inputMetaData);
  }), _defineProperty(_ref, c.carrayCounter, function (inputData, inputMetaData) {
