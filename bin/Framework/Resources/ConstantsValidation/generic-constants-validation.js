...
var genericConstantsValidation = [{
  ...
  Name: 'cDotDotForwardSlash',
  Actual: g.cDotDotForwardSlash,
  Expected: '../'
}, // Boolean strings
{
  Name: 'cTrue',
  ...
  Actual: g.cNOT,
  Expected: 'NOT'
}, // g.c_NO + g.cT, Expected: 'NOTE cNOT is some how a reserved word that is a variable.
{
  Name: 'cnotok',
  Actual: g.cnotok,
  Expected: 'notok'
...
{
  Name: 'cLowerCaseEnglishAlphabet',
  Actual: g.cLowerCaseEnglishAlphabet,
  Expected: 'abcdefghijklmnopqrstuvwxyz'
}, {
  Name: 'cUpperCaseEnglishAlphabet',
  Actual: g.cUpperCaseEnglishAlphabet,
  Expected: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'
}, {
  Name: 'cAllNumbers',
  Actual: g.cAllNumbers,
  Expected: '0123456789'
}, // File Extensions
{
  Name: 'cdoc',
