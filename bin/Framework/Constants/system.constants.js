...
var cAliases = cAlias + b.ces;
exports.cAliases = cAliases;
var csequencer = g.cseq + b.cue + g.cncer;
exports.csequencer = csequencer;
var cSequencer = g.cSeq + b.cue + g.cncer;
exports.cSequencer = cSequencer;
var cprimary = g.cpri + g.cmary;
exports.cprimary = cprimary;
var cPrimary = g.cPri + g.cmary;
exports.cPrimary = cPrimary;
var csecondary = g.csecond + g.cary;
exports.csecondary = csecondary;
var cSecondary = g.cSecond + g.cary;
exports.cSecondary = cSecondary;
var ctertiary = g.ctert + g.ciary;
...
var cHelp = b.cHe + b.clp;
exports.cHelp = cHelp;
var cprint = b.cp + g.crint;
exports.cprint = cprint;
var cPrint = b.cP + g.crint;
exports.cPrint = cPrint;
var chive = b.ch + g.cive;
exports.chive = chive;
var cHive = b.cH + g.cive;
exports.cHive = cHive;
var cgenerator = g.cgen + b.cer + g.cator;
exports.cgenerator = cgenerator;
var cGenerator = g.cGen + b.cer + g.cator;
exports.cGenerator = cGenerator;
var cindex = b.cin + g.cdex;
exports.cindex = cindex;
var cIndex = b.cIn + g.cdex;
exports.cIndex = cIndex;
var cabout = b.ca + g.cbout;
exports.cabout = cabout;
var cAbout = b.cA + g.cbout;
exports.cAbout = cAbout;
var cstart = b.cs + g.ctart;
...
var cTrack = b.cT + crack;
exports.cTrack = cTrack;
var ctracking = ctrack + g.cing;
exports.ctracking = ctracking;
var cTracking = cTrack + g.cing;
exports.cTracking = cTracking;
var cstack = b.cst + g.cack;
exports.cstack = cstack;
var cStack = b.cSt + g.cack;
exports.cStack = cStack;
var cstandard = b.cst + cand + g.card;
exports.cstandard = cstandard;
var cStandard = b.cSt + cand + g.card;
exports.cStandard = cStandard;
var cdeviation = g.cdev + b.cia + g.ction;
exports.cdeviation = cdeviation;
var cDeviation = g.cDev + b.cia + g.ction;
exports.cDeviation = cDeviation;
var canalysis = g.cana + b.cly + g.csis;
exports.canalysis = canalysis;
var cAnalysis = g.cAna + b.cly + g.csis;
exports.cAnalysis = cAnalysis;
var cclear = b.ccl + g.cear;
exports.cclear = cclear;
var cClear = b.cCl + g.cear;
exports.cClear = cClear;
var cversion = g.cver + g.csion;
exports.cversion = cversion;
var cVersion = g.cVer + g.csion; // b.cVe + b.crs + b.cio + b.cn; // 'Version';
...
var cconversion = g.ccon + cversion;
exports.cconversion = cconversion;
var cConversion = g.cCon + cversion; // Shapes
...
var crandomlyGenerate = crandomly + cGenerate;
...
var cbusinessRule = cbusiness + cRule;
...
var cFramework = cFrame + cwork;
exports.cFramework = cFramework;
var cCommandsAliases = cCommands + cAliases;
exports.cCommandsAliases = cCommandsAliases;
var cCommandWorkflows = cCommand + cWorkflows;
exports.cCommandWorkflows = cCommandWorkflows;
var cStandardDeviation = cStandard + cDeviation;
exports.cStandardDeviation = cStandardDeviation;
var cHexValue = g.cHex + cValue; // Logging Constants
...
var cApplicationDescription = cApplication + cDescription;
...
var cCommandQueue = cCommand + cQueue; // Configuration Settings
...
var cPrimaryCommandDelimiter = cPrimary + cCommand + cDelimiter;
exports.cPrimaryCommandDelimiter = cPrimaryCommandDelimiter;
var cSecondaryCommandDelimiter = cSecondary + cCommand + cDelimiter;
exports.cSecondaryCommandDelimiter = cSecondaryCommandDelimiter;
var cTertiaryCommandDelimiter = cTertiary + cCommand + cDelimiter;
exports.cTertiaryCommandDelimiter = cTertiaryCommandDelimiter;
var cEnableBusinessRuleOutput = cEnable + cBusiness + cRule + cOutput;
exports.cEnableBusinessRuleOutput = cEnableBusinessRuleOutput;
var cEnableBusinessRulePerformanceMetrics = cEnable + cBusiness + cRule + cPerformance + cMetrics;
exports.cEnableBusinessRulePerformanceMetrics = cEnableBusinessRulePerformanceMetrics;
var cEnableCommandPerformanceMetrics = cEnable + cCommand + cPerformance + cMetrics; // Test Time Tracking
...
var cEndTimeStampVariableName = cEnd + cTimeStampVariableName;
exports.cEndTimeStampVariableName = cEndTimeStampVariableName;
var cBusinessRulePerformanceTrackingStack = cBusiness + cRule + cPerformance + cTracking + cStack;
exports.cBusinessRulePerformanceTrackingStack = cBusinessRulePerformanceTrackingStack;
var cBusinessRuleNamesPerformanceTrackingStack = cBusiness + cRule + cNames + cPerformance + cTracking + cStack;
exports.cBusinessRuleNamesPerformanceTrackingStack = cBusinessRuleNamesPerformanceTrackingStack;
var cBusinessRulesPerformanceAnalysisStack = cBusiness + cRules + cPerformance + cAnalysis + cStack;
exports.cBusinessRulesPerformanceAnalysisStack = cBusinessRulesPerformanceAnalysisStack;
var cClearBusinessRulesPerformanceDataAfterAnalysis = cClear + cBusiness + cRules + cPerformance + cData + cAfter + cAnalysis;
exports.cClearBusinessRulesPerformanceDataAfterAnalysis = cClearBusinessRulesPerformanceDataAfterAnalysis;
var cCommandPerformanceTrackingStack = cCommand + cPerformance + cTracking + cStack;
exports.cCommandPerformanceTrackingStack = cCommandPerformanceTrackingStack;
var cCommandNamesPerformanceTrackingStack = cCommand + cNames + cPerformance + cTracking + cStack;
exports.cCommandNamesPerformanceTrackingStack = cCommandNamesPerformanceTrackingStack;
var cCommandsPerformanceAnalysisStack = cCommands + cPerformance + cAnalysis + cStack;
exports.cCommandsPerformanceAnalysisStack = cCommandsPerformanceAnalysisStack;
var cClearCommandPerformanceDataAfterAnalysis = cClear + cCommand + cPerformance + cData + cAfter + cAnalysis; // Business Rules
...
var cmapWordToCamelCaseWord = g.cmap + cWord + b.cTo + cCamel + cCase + cWord;
...
var cdoesArrayContainCharacter = cdoes + cArray + cContain + cCharacter;
exports.cdoesArrayContainCharacter = cdoesArrayContainCharacter;
var cremoveCharacterFromArray = cremove + cCharacter + cFrom + cArray;
...
var cisOdd = b.cis + cOdd;
exports.cisOdd = cisOdd;
var cisEven = b.cis + cEven;
exports.cisEven = cisEven;
var creplaceCharacterAtIndex = creplace + cCharacter + cAt + cIndex; // *********************************
...
var chex2rgbConversion = g.chex + b.c2 + g.crgb + cConversion; // Commands
...
var cSystemWorkflowsActualPath = csrc + b.cForwardSlash + cFramework + b.cForwardSlash + cResources + b.cForwardSlash + cWorkflows + b.cForwardSlash;
...
var cSystemWorkflowsPath = cSystem + cWorkflows + cPath;
exports.cSystemWorkflowsPath = cSystemWorkflowsPath;
var cClientWorkflowsPath = cClient + cWorkflows + cPath; // ********************************
...
var cEchoCommand = cEcho + cCommand;
exports.cEchoCommand = cEchoCommand;
var cworkflowHelp = cworkflow + cHelp;
exports.cworkflowHelp = cworkflowHelp;
var ccommandSequencer = ccommand + cSequencer;
exports.ccommandSequencer = ccommandSequencer;
var cprintDataHive = cprint + cData + cHive;
exports.cprintDataHive = cprintDataHive;
var ccommandGenerator = ccommand + cGenerator;
exports.ccommandGenerator = ccommandGenerator;
var cbusinessRulesMetrics = cbusiness + cRules + cMetrics;
exports.cbusinessRulesMetrics = cbusinessRulesMetrics;
var ccommandMetrics = ccommand + cMetrics;
exports.ccommandMetrics = ccommandMetrics;
var cconvertColors = cconvert + cColors; // ********************************
// System defined workflows
// ********************************

exports.cconvertColors = cconvertColors;
var cStartupWorkflow = cWorkflow + b.cSpace + cstartup;
