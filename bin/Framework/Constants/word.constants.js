...
exports.cPath = cPath;
var cpaths = cpath + bas.cs; // paths

exports.cpaths = cpaths;
var cPaths = cPath + bas.cs; // Paths
...
exports.cSetting = cSetting;
var csettings = csetting + bas.cs; // settings
...
exports.cPal = cPal;
var cpalindrome = cpal + bas.cin + phn.cdrome; // palindrome

exports.cpalindrome = cpalindrome;
var cPalindrome = cPal + bas.cin + phn.cdrome; // Palindrome
...
exports.cControl = cControl;
var ccontrols = ccontrol + bas.cs; // controls

exports.ccontrols = ccontrols;
var cControls = cControl + bas.cs; // Controls

exports.cControls = cControls;
var ccontrolled = ccontrol + phn.cled; // controlled

exports.ccontrolled = ccontrolled;
var cControlled = cControl + phn.cled; // Controlled

exports.cControlled = cControlled;
var ccontrolling = ccontrol + phn.cling; // controlling

exports.ccontrolling = ccontrolling;
var cControlling = cControl + phn.cling; // Controlling

exports.cControlling = cControlling;
var ccontroller = ccontrol + phn.cler; // controller

exports.ccontroller = ccontroller;
var cController = cControl + phn.cler; // Controller

exports.cController = cController;
var ccontrollers = ccontroller + bas.cs; // controllers

exports.ccontrollers = ccontrollers;
var cControllers = cController + bas.cs; // Controllers
...
exports.cCannot = cCannot;
var cnothing = gen.cnot + phn.ching; // nothing

exports.cnothing = cnothing;
var cNothing = gen.cNot + phn.ching; // Nothing

exports.cNothing = cNothing;
var cnothingness = cnothing + phn.cness; // nothingness

exports.cnothingness = cnothingness;
var cNothingness = cNothing + phn.cness; // Nothingness
...
exports.cIncrementing = cIncrementing;
var cforce = cfor + bas.cce; // force

exports.cforce = cforce;
var cForce = cFor + bas.cce; // Force

exports.cForce = cForce;
var cforced = cforce + bas.cd; // forced

exports.cforced = cforced;
var cForced = cForce + bas.cd; // Forced

exports.cForced = cForced;
var cforcing = cfor + bas.cc + phn.cing; // forcing

exports.cforcing = cforcing;
var cForcing = cFor + bas.cc + phn.cing; // Forcing

exports.cForcing = cForcing;
var cforces = cforce + bas.cs; // forces

exports.cforces = cforces;
var cForces = cForce + bas.cs; // Forces

exports.cForces = cForces;
var cexecutrix = phn.cexe + ccut + phn.crix; // executrix

exports.cexecutrix = cexecutrix;
var cExecutrix = phn.cExe + ccut + phn.crix; // Executrix
//////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
