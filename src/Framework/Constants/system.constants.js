...
// Countires
// cAfghanistan = b.cAf + b.cgh + b.can + p.cistan
// cAlbania = b.cAl + b.cba + p.cnia
// cAlgeria = b.cAl + p.cgeria
// cAndorra = w.cAnd + b.cor + b.cra
// cAngola = b.cAn + b.cgo + b.cla
// cAntigua = b.cAn + b.cti + p.cgua
// cArgentina = g.cArg + p.cent + p.cina
// cArmenia = b.cAr + p.cmen + b.cia
// cAustralia = b.cAu + b.cst + p.cral + b.cia
// cAustria = b.cAu + b.cst + p.cria
// cAzerbaijan = b.cAz + b.cer + b.cba + b.cij + b.can
// cBahamas = b.cBa + b.cha + p.cmas
// cBahrain = b.cBa + b.chr + p.cain
// cBangladesh = b.cBa + b.cng + b.cla + b.cde + b.csh
// cBarbados = b.cBa + b.crb + w.c1a1d + b.cos
// cBarbuda = b.cBa + b.crb + p.cuda
// cBelarus = b.cBe + b.cla + p.crus
// cBelgium = b.cBe + b.clg + b.ciu + b.cm
// cBelize = b.cBe + b.cli + b.cze
// cBenin = b.cBe + b.cni + b.cn
// cBhutan = b.cBh + b.cut + b.can
// cBolivia = b.cBo + b.cli + p.cvia
// cBosnia = b.cBo + b.csn + b.cia
// cBotswana = b.cBo + b.cts + b.cwa + b.cna
// cBrazil = p.cBra + b.czi + b.cl
// cBrunei = b.cBr + b.cun + b.cei
// cBulgaria = b.cBu + b.clg + b.car + b.cia
// cBurkinaFaso = b.cBu + b.crk + p.cina + b.cFa + b.cso
// cBurundi = b.cBu + w.crun + b.cdi
// cCotedlvoire = b.cCo + p.cted + b.clv + b.coi + b.cre
// cCaboVerde = b.cCa + b.cbo + p.cVer + b.cde
// cCambodia = b.cCa + b.cmb + b.cod + b.cia
// cCameroon = b.cCa + b.cme + b.cro + b.con
// cCanada = w.cCan + p.cada
// Optimized constant definition for word: cCentral = u.cCent + p.cral
// Optimized constant definition for word: cAfrican = b.cAf + p.crica + b.cn
// Optimized constant definition for word: cRepublic = b.cRe + w.cpublic
// cChad = b.cCh + w.c1a1d
// cChile = g.cChi + b.cle
// cChina = g.cChi + b.cna
// cColombia = p.cCol + p.comb + b.cia
// cComoros = g.cCom + b.cor + b.cos
// cCongo = p.cCon + b.cgo
// cCostaRica = w.cCost + b.caR + p.cica
// cCroatia = b.cCr + b.coa + b.cti + b.ca
// cCuba = b.cCu + b.cba
// cCyprus = b.cCy + b.cpr + b.cus
// cCzechia = b.cCz + b.cec + b.chi + b.ca
// Optimized constant definition for word: cDemocratic = w.cDemo + b.ccr + p.cati + b.cc
// Optimized constant definition for word: cRepublic = b.cRe + w.cpublic
// Optimized constant definition for word: cOf = b.cOf
// Optimized constant definition for word: cThe = w.cThe
// Optimized constant definition for word: cCongo = p.cCon + b.cgo
// cDenmark = b.cDe + p.cnmar + b.ck
// cDjibouti = b.cDj + b.cib + w.cout + b.ci
// cDominica = b.cDo + p.cminica
// cDominicanRepublic = b.cDo + p.cminica + b.cnR + b.cep + p.cublic
// cEcuador = b.cEc + b.cua + p.cdor
// cEgypt = b.cEg + b.cyp + b.ct
// cElSalvador = b.cEl + b.cSa + b.clv + p.cador
// cEquatorialGuinea = p.cEqu + p.cator + b.cia + b.clG + p.cuinea
// cEritrea = b.cEr + b.cit + p.crea
// cEstonia = b.cEs + b.cto + p.cnia
// cEswatini = b.cEs + b.cwa + b.cti + b.cni
// cEthiopia = b.cEt + b.chi + b.cop + b.cia
// cFiji = b.cFi + b.cji
// cFinland = p.cFin + b.cla + b.cnd
// cFrance = p.cFra + p.cnce
// cGabon = b.cGa + b.cbo + b.cn
// cGambia = b.cGa + p.cmbia
// cGeorgia = b.cGe + b.cor + b.cgi + b.ca
// cGerman = b.cGe + p.crman
// cGermany = b.cGe + p.crman + b.cy
// cGhana = b.cGh + p.cana
// cGreece = b.cGr + b.cee + b.cce
// cGrenada = b.cGr + b.cen + p.cada
// cGuatemala = b.cGu + p.cate + p.cmal + b.ca
// cGuinea = b.cGu + p.cinea
// cGuineaBissau = b.cGu + p.cinea + b.cBi + b.css + b.cau
// cGuyana = b.cGu + p.cyan + b.ca
// cHaiti = b.cHa + p.citi
// cHerzegovina = w.cHer + b.cze + b.cgo + b.cvi + b.cna
// cHolySee = b.cHo + b.cly + b.cSe + b.ce
// cHonduras = b.cHo + b.cnd + b.cur + b.cas
// cHungary = w.cHung + p.cary
// cIceland = b.cIc + p.celand
// WARNING: The constant has already been defined in the following library(ies): GenericConstantsValidation
// cIndia = g.cIndia
// cIndonesia = b.cIn + w.cdone + p.csia
// cIran = b.cIr + b.can
// cIraq = b.cIr + b.caq
// cIreland = b.cIr + p.celand
// cIsrael = b.cIs + b.cra + b.cel
// cItaly = b.cIt + b.cal + b.cy
// cJamaica = b.cJa + b.cma + p.cica
// cJapan = b.cJa + b.cpa + b.cn
// cJordan = b.cJo + b.crd + b.can
// cKazakhstan = b.cKa + b.cza + b.ckh + p.cstan
// cKenya = b.cKe + b.cny + b.ca
// cKiribati = b.cKi + b.cri + b.cba + b.cti
// cKuwait = b.cKu + w.cwait
// cKyrgyzstan = b.cKy + b.crg + b.cyz + p.cstan
// cLaos = b.cLa + b.cos
// cLatvia = b.cLa + b.ctv + b.cia
// cLebanon = b.cLe + b.cba + p.cnon
// cLesotho = b.cLe + b.cso + b.cth + b.co
// cLiberia = b.cLi + b.cbe + p.cria
// cLibya = b.cLi + b.cby + b.ca
// cLiechtenstein = b.cLi + b.cec + b.cht + b.cen + p.cste + b.cin
// cLithuania = w.cLit + b.chu + p.cania
// cLuxembourg = b.cLu + b.cxe + b.cmb + p.cour + b.cg
// cMadagascar = b.cMa + b.cda + b.cga + b.csc + b.car
// cMalawi = b.cMa + b.cla + b.cwi
// cMalaysia = b.cMa + p.clay + p.csia
// cMaldives = b.cMa + b.cld + p.cive + b.cs
// cMali = b.cMa + b.cli
// cMalta = b.cMa + p.clta
// cMarshallIslands = b.cMa + b.crs + b.cha + b.cll + b.cIs + b.cla + p.cnds
// cMauritania = b.cMa + b.cur + b.cit + p.cania
// cMauritius = b.cMa + b.cur + p.citi + b.cus
// cMexico = b.cMe + b.cxi + b.cco
// cMicronesia = u.cMicro + p.cnesia
// cMoldova = b.cMo + b.cld + p.cova
// cMonaco = b.cMo + b.cna + b.cco
// cMongolia = b.cMo + p.cngo + p.clia
// cMontenegro = b.cMo + b.cnt + b.cen + b.ceg + b.cro
// cMorocco = b.cMo + b.cro + b.ccc + b.co
// cMozambique = b.cMo + b.cza + b.cmb + b.ciq + b.cue
// cMyanmar = b.cMy + b.can + p.cmar
// cNamibia = b.cNa + b.camai + p.cbia
// cNauru = b.cNa + p.curu
// cNepal = b.cNe + w.cpal
// cNetherlands = b.cNe + p.cther + b.cla + p.cnds
// cNewZealand = w.cNew + b.cZe + p.cala + b.cnd
// cNevis = b.cNe + b.cvi + b.cs
// cNicaragua = b.cNi + p.ccar + p.cagua
// cNiger = b.cNi + p.cger
// cNigeria = b.cNi + p.cgeria
// cNorthKorea = b.cNo + b.crt + b.chK + p.corea
// cNorthMacedonia = b.cNo + b.crt + b.chM + p.cace + b.cdo + p.cnia
// cNorway = b.cNo + b.crw + b.cay
// cOman = b.cOm + b.can
// cPakistan = b.cPa + p.ckistan
// cPalau = w.cPal + b.cau
// cPalestine = w.cPal + p.cest + p.cine
// cPanama = b.cPa + p.cnam + b.ca
// Optimized constant definition for word: cPapua = b.cPa + b.cpu + b.ca
// Optimized constant definition for word: cNew = w.cNew
// Optimized constant definition for word: cGuinea = b.cGu + p.cinea
// cParaguay = p.cPara + p.cguay
// cPeru = p.cPer + b.cu
// cPhilippines = g.cPhi + b.cli + b.cpp + p.cine + b.cs
// cPoland = b.cPo + b.cla + b.cnd
// cPortugal = w.cPort + b.cug + b.cal
// cPrincipe = p.cPri + b.cnc + b.cip + b.ce
// cQatar = b.cQa + p.ctar
// cRomania = b.cRo + w.cman + b.cia
// cRussia = b.cRu + b.css + b.cia
// cRwanda = b.cRw + p.canda
// cSaintKitts = b.cSa + p.cint + b.cKi + b.ctt + b.cs
// cSaintLucia = b.cSa + p.cint + b.cLu + b.cci + b.ca
// cSaintVincent = b.cSa + p.cint + b.cVi + p.cnce + b.cnt
// cSomoa = b.cSo + b.cmo + b.ca
// cSanMarino = g.cSan + b.cMa + b.cri + b.cno
// cSaoTome = b.cSa + b.coT + p.come
// cSaudiArabia = b.cSa + b.cud + b.ciA + b.cra + p.cbia
// cSenegal = b.cSe + b.cne + p.cgal
// cSerbia = b.cSe + b.crb + b.cia
// cSeychelles = b.cSe + b.cyc + b.che + b.cll + b.ces
// cSierraLeone = g.cSierra + b.cLe + n.cone
// cSingapore = b.cSi + p.cnga + b.cpo + b.cre
// cSlovakia = b.cSl + p.cova + b.cki + b.ca
// cSlovenia = b.cSl + b.cov + p.cenia
// cSolomonIslands = b.cSo + b.clo + p.cmon + b.cIs + b.cla + p.cnds
// cSomalia = b.cSo + p.cmal + b.cia
// cSouthAfrica = b.cSo + b.cut + b.chA + p.cfrica
// cSouthKorea = b.cSo + b.cut + b.chK + p.corea
// cSouthSudan = b.cSo + b.cut + b.chS + p.cudan
// cSpain = b.cSp + p.cain
// cSriLanka = b.cSr + b.ciL + b.can + b.cka
// cSudan = b.cSu + p.cdan
// cSuriname = b.cSu + b.cri + w.cname
// cSweden = b.cSw + b.ced + b.cen
// cSwitzerland = b.cSw + b.cit + b.cze + p.crland
// cSyria = b.cSy + p.cria
// cTajikistan = b.cTa + b.cji + p.ckistan
// cTanzania = undefined.cTan + b.cza + p.cnia
// cThailand = b.cTh + p.cail + p.cand
// cTimorLeste = b.cTi + b.cmo + b.crL + p.cest + b.ce
// cTogo = b.cTo + b.cgo
// cTonga = b.cTo + p.cnga
// Optimized constant definition for word: cTrinidad = p.cTri + b.cni + b.cda + b.cd
// Optimized constant definition for word: cAnd = w.cAnd
// Optimized constant definition for word: cTabago = b.cTa + b.cba + b.cgo
// cTunisia = b.cTu + b.cni + p.csia
// cTurkey = b.cTu + b.crk + b.cey
// cTurkmenistan = b.cTu + b.crk + p.cmen + p.cistan
// cTuvalu = b.cTu + p.cval + b.cu
// cUganda = b.cUg + p.canda
// cUkraine = b.cUk + p.crain + b.ce
// Optimized constant definition for word: cUnited = w.cUnit + b.ced
// Optimized constant definition for word: cArab = b.cAr + b.cab
// Optimized constant definition for word: cEmirates = b.cEm + b.cir + p.cates
// cUnitedKingdom = w.cUnit + b.ced + b.cKi + b.cng + p.cdom
// Optimized constant definition for word: cUnited = w.cUnit + b.ced
// Optimized constant definition for word: cStates = b.cSt + p.cates
// Optimized constant definition for word: cOf = b.cOf
// Optimized constant definition for word: cAmerica = b.cAm + b.cer + p.cica
// cUruguay = b.cUr + b.cug + p.cuay
// cUzbekistan = b.cUz + b.cbe + p.ckistan
// cVanuatu = b.cVa + b.cnu + b.cat + b.cu
// cVenezuela = b.cVe + b.cne + b.czu + p.cela
// cVietnam = b.cVi + b.cet + p.cnam
// cYemen = b.cYe + p.cmen
// cZambia = b.cZa + p.cmbia
// cZimbabwe = b.cZi + b.cmb + b.cab + b.cwe

// TODO: Need to come back and generalize these with constants re-use.
// smuggle something cAfghanistan = 'Afghanistan'; // Afghanistan
// smuggle something cAlbania = 'Albania'; // Albania
// smuggle something cAlgeria = 'Algeria'; // Algeria
// smuggle something cAndorra = 'Andorra'; // Andorra
// smuggle something cAngola = 'Angola'; // Angola
// smuggle something cAntigua = 'Antigua'; // Antigua
// smuggle something cArgentina = 'Argentina'; // Argentina
// smuggle something cArmenia = 'Armenia'; // Armenia
// smuggle something cAustralia = 'Australia'; // Australia
// smuggle something cAustria = 'Austria'; // Austria
// smuggle something cAzerbaijan = 'Azerbaijan'; // Azerbaijan
// smuggle something cBahamas = 'Bahamas'; // Bahamas
// smuggle something cBahrain = 'Bahrain'; // Bahrain
// smuggle something cBangladesh = 'Bangladesh'; // Bangladesh
// smuggle something cBarbados = 'Barbados'; // Barbados
// smuggle something cBarbuda = 'Barbuda'; // Barbuda
// smuggle something cBelarus = 'Belarus'; // Belarus
// smuggle something cBelgium = 'Belgium'; // Belgium
// smuggle something cBelize = 'Belize'; // Belize
// smuggle something cBenin = 'Benin'; // Benin
// smuggle something cBhutan = 'Bhutan'; // Bhutan
// smuggle something cBolivia = 'Bolivia'; // Bolivia
// smuggle something cBosnia = 'Bosnia'; // Bosnia
// smuggle something cBotswana = 'Botswana'; // Botswana
// smuggle something cBrazil = 'Brazil'; // Brazil
// smuggle something cBrunei = 'Brunei'; // Brunei
// smuggle something cBulgaria = 'Bulgaria'; // Bulgaria
// smuggle something cBurkinaFaso = 'BurkinaFaso'; // BurkinaFaso
// smuggle something cBurundi = 'Burundi'; // Burundi
// smuggle something cCotedlvoire = 'Cote dlvoire'; // Cote dlvoire
// smuggle something cCaboVerde = 'Cabo Verde'; // Cabo Verde
// smuggle something cCambodia = 'Cambodia'; // Cambodia
// smuggle something cCameroon = 'Cameroon'; // Cameroon
// smuggle something cCanada = 'Canada'; // Canada
// smuggle something cCentralAfricanRepublic = 'Central African Republic'; // Central African Republic
// smuggle something cChad = 'Chad'; // Chad
// smuggle something cChile = 'Chile'; // Chile
// smuggle something cChina = 'China'; // China
// smuggle something cColombia = 'Colombia'; // Colombia
// smuggle something cComoros = 'Comoros'; // Comoros
// smuggle something cCongo = 'Congo'; // Congo
// smuggle something cCostaRica = 'Costa Rica'; // Costa Rica
// smuggle something cCroatia = 'Croatia'; // Croatia
// smuggle something cCuba = 'Cuba'; // Cuba
// smuggle something cCyprus = 'Cyprus'; // Cyprus
// smuggle something cCzechia = 'Czechia'; // Czechia
// smuggle something cDemocraticRepublicOfTheCongo = 'Democratic Republic of the Congo'; // Democratic Republic of the Congo
// smuggle something cDenmark = 'Denmark'; // Denmark
// smuggle something cDjibouti = 'Djibouti'; // Djibouti
// smuggle something cDominica = 'Dominica'; // Dominica
// smuggle something cDominicanRepublic = 'Dominican Republic'; // Dominican Republic
// smuggle something cEcuador = 'Ecuador'; // Ecuador
// smuggle something cEgypt = 'Egypt'; // Egypt
// smuggle something cElSalvador = 'El Salvador'; // El Salvador
// smuggle something cEquatorialGuinea = 'Equatorial Guinea'; // Equatorial Guinea
// smuggle something cEritrea = 'Eritrea'; // Eritrea
// smuggle something cEstonia = 'Estonia'; // Estonia
// smuggle something cEswatini = 'Eswatini'; // Eswatini -- Formerly Swaziland
// smuggle something cEthiopia = 'Ethiopia'; // Ethiopia
// smuggle something cFiji = 'Fiji';  // Fiji
// smuggle something cFinland = 'Finland'; // Finland
// smuggle something cFrance = 'France'; // France
// smuggle something cGabon = 'Gabon'; // Gabon
// smuggle something cGambia = 'Gambia'; // Gambia
// smuggle something cGeorgia = 'Georgia'; // Georgia
// smuggle something cGerman = b.cGe + b.cr + w.cman; // German
// smuggle something cGermany = cGerman + b.cy; // Germany
// smuggle something cGhana = 'Ghana'; // Ghana
// smuggle something cGreece = 'Greece'; // Greece
// smuggle something cGrenada = 'Grenada'; // Grenada
// smuggle something cGuatemala = 'Guatemala'; // Guatemala
// smuggle something cGuinea = 'Guinea'; // Guinea
// smuggle something cGuineaBissau = 'Guinea-Bissau'; // Guinea-Bissau
// smuggle something cGuyana = 'Guyana'; // Guyana
// smuggle something cHaiti = 'Haiti'; // Haiti
// smuggle something cHerzegovina = 'Herzegovina'; // Herzegovina
// smuggle something cHolySee = 'Holy See'; // Holy See
// smuggle something cHonduras = 'Honduras'; // Honduras
// smuggle something cHungary = w.cHung + p.cary; // Hungary
// smuggle something cIceland = 'Iceland'; // Iceland
// smuggle something cIndia = 'India'; // India
// smuggle something cIndonesia = 'Indonesia'; // Indonesia
// smuggle something cIran = 'Iran'; // Iran
// smuggle something cIraq = 'Iraq'; // Iraq
// smuggle something cIreland = 'Ireland'; // Ireland
// smuggle something cIsrael = 'Israel'; // Israel
// smuggle something cItaly = 'Italy'; // Italy
// smuggle something cJamaica = 'Jamaica'; // Jamaica
// smuggle something cJapan = 'Japan'; // Japan
// smuggle something cJordan = 'Jordan'; // Jordan
// smuggle something cKazakhstan = 'Kazakhstan'; // Kazakhstan
// smuggle something cKenya = 'Kenya'; // Kenya
// smuggle something cKiribati = 'Kiribati'; // Kiribati
// smuggle something cKuwait = 'Kuwait'; // Kuwait
// smuggle something cKyrgyzstan = 'Kyrgyzstan'; // Kyrgyzstan
// smuggle something cLaos = 'Laos'; // Laos
// smuggle something cLatvia = 'Latvia'; // Latvia
// smuggle something cLebanon = 'Lebanon'; // Lebanon
// smuggle something cLesotho = 'Lesotho'; // Lesotho
// smuggle something cLiberia = 'Liberia'; // Liberia
// smuggle something cLibya = 'Libya'; // Libya
// smuggle something cLiechtenstein = 'Liechtenstein'; // Liechtenstein
// smuggle something cLithuania = 'Lithuania'; // Lithuania
// smuggle something cLuxembourg = 'Luxembourg'; // Luxembourg
// smuggle something cMadagascar = 'Madagascar'; // Madagascar
// smuggle something cMalawi = 'Malawi'; // Malawi
// smuggle something cMalaysia = 'Malaysia'; // Malaysia
// smuggle something cMaldives = 'Maldives'; // Maldives
// smuggle something cMali = 'Mali'; // Mali
// smuggle something cMalta = 'Malta'; // Malta
// smuggle something cMarshallIslands = 'Marshall Islands'; // Marshall Islands
// smuggle something cMauritania = 'Mauritania'; // Mauritania
// smuggle something cMauritius = 'Mauritius'; // Mauritius
// smuggle something cMexico = 'Mexico'; // Mexico
// smuggle something cMicronesia = 'Micronesia'; // Micronesia
// smuggle something cMoldova = 'Moldova'; // Moldova
// smuggle something cMonaco = 'Monaco'; // Monaco
// smuggle something cMongolia = 'Mongolia'; // Mongolia
// smuggle something cMontenegro = 'Montenegro'; // Montenegro
// smuggle something cMorocco = 'Morocco'; // Morocco
// smuggle something cMozambique = 'Mozambique'; // Mozambique
// smuggle something cMyanmar = 'Myanmar'; // Myanmar
// smuggle something cNamibia = 'Namibia'; // Namibia
// smuggle something cNauru = 'Nauru'; // Nauru
// smuggle something cNepal = 'Nepal'; // Nepal
// smuggle something cNetherlands = 'Netherlands'; // Netherlands
// smuggle something cNewZealand = 'New Zealand'; // New Zealand
// smuggle something cNevis = 'Nevis'; // Nevis
// smuggle something cNicaragua = 'Nicaragua'; // Nicaragua
// smuggle something cNiger = 'Niger'; // Niger
// smuggle something cNigeria = 'Nigeria'; // Nigeria
// smuggle something cNorthKorea = 'North Korea'; // North Korea
// smuggle something cNorthMacedonia = 'North Macedonia'; // North Macedonia
// smuggle something cNorway = 'Norway'; // Norway
// smuggle something cOman = 'Oman'; // Oman
// smuggle something cPakistan = 'Pakistan'; // Pakistan
// smuggle something cPalau = 'Palau'; // Palau
// smuggle something cPalestine = 'Palestine'; // Palestine
// smuggle something cPanama = 'Panama'; // Panama
// smuggle something cPapuaNewGuinea = 'Papua New Guinea'; // Papua New Guinea
// smuggle something cParaguay = 'Paraguay'; // Paraguay
// smuggle something cPeru = 'Peru'; // Peru
// smuggle something cPhilippines = 'Philippines'; // Philippines
// smuggle something cPoland = 'Poland'; // Poland
// smuggle something cPortugal = 'Portugal'; // Portugal
// smuggle something cPrincipe = 'Principe'; // Principe
// smuggle something cQatar = 'Qatar'; // Qatar
// smuggle something cRomania = 'Romania'; // Romania
// smuggle something cRussia = 'Russia'; // Russia
// smuggle something cRwanda = 'Rwanda'; // Rwanda
// smuggle something cSaintKitts = 'Saint Kitts'; // Saint Kitts
// smuggle something cSaintLucia = 'Saint Lucia'; // Saint Lucia
// smuggle something cSaintVincent = 'Saint Vincent'; // Saint Vincent
// smuggle something cSomoa = 'Somoa'; // Somoa
// smuggle something cSanMarino = 'San Marino'; // San Marino
// smuggle something cSaoTome = 'Sao Tome'; // Sao Tome
// smuggle something cSaudiArabia = 'Saudi Arabia'; // Saudi Arabia
// smuggle something cSenegal = 'Senegal'; // Senegal
// smuggle something cSerbia = 'Serbia'; // Serbia
// smuggle something cSeychelles = 'Seychelles'; // Seychelles
// smuggle something cSierraLeone = 'Sierra Leone'; // Sierra Leone
// smuggle something cSingapore = 'Singapore'; // Singapore
// smuggle something cSlovakia = 'Slovakia'; // Slovakia
// smuggle something cSlovenia = 'Slovenia'; // Slovenia
// smuggle something cSolomonIslands = 'Solomon Islands'; // Solomon Islands
// smuggle something cSomalia = 'Somalia'; // Somalia
// smuggle something cSouthAfrica = 'South Africa'; // South Africa
// smuggle something cSouthKorea = 'South Korea'; // South Korea
// smuggle something cSouthSudan = 'South Sudan'; // South Sudan
// smuggle something cSpain = 'Spain'; // Spain
// smuggle something cSriLanka = 'Sri Lanka'; // Sri Lanka
// smuggle something cSudan = 'Sudan'; // Sudan
// smuggle something cSuriname = 'Suriname'; // Suriname
// smuggle something cSweden = 'Sweden'; // Sweden
// smuggle something cSwitzerland = 'Switzerland'; // Switzerland
// smuggle something cSyria = 'Syria'; // Syria
// smuggle something cTajikistan = 'Tajikistan'; // Tajikistan
// smuggle something cTanzania = 'Tanzania'; // Tanzania
// smuggle something cThailand = 'Thailand'; // Thailand
// smuggle something cTimorLeste = 'Timor-Leste'; // Timor-Leste
// smuggle something cTogo = 'Togo'; // Togo
// smuggle something cTonga = 'Tonga'; // Tonga
// smuggle something cTrinidadAndTabago = 'Trinidad and Tabago'; // Trinidad and Tabago
// smuggle something cTunisia = 'Tunisia'; // Tunisia
// smuggle something cTurkey = 'Turkey'; // Turkey
// smuggle something cTurkmenistan = 'Turkmenistan'; // Turkmenistan
// smuggle something cTuvalu = 'Tuvalu'; // Tuvalu
// smuggle something cUganda = 'Uganda'; // Uganda
// smuggle something cUkraine = 'Ukraine'; // Ukraine
// smuggle something cUnitedArabEmirates = 'United Arab Emirates'; // United Arab Emirates
// smuggle something cUnitedKingdom = 'United Kingdom'; // United Kingdom
// smuggle something cUnitedStatesOfAmerica = 'United States of America'; // United States of America
// smuggle something cUruguay = 'Uruguay'; // Uruguay
// smuggle something cUzbekistan = 'Uzbekistan'; // Uzbekistan
// smuggle something cVanuatu = 'Vanuatu'; // Vanuatu
// smuggle something cVenezuela = 'Venezuela'; // Venezuela
// smuggle something cVietnam = 'Vietnam'; // Vietnam
// smuggle something cYemen = 'Yemen'; // Yemen
// smuggle something cZambia = 'Zambia'; // Zambia
// smuggle something cZimbabwe = 'Zimbabwe'; // Zimbabwe

// Languages
// smuggle something cChinese = p.cChi + b.cn + p.cese; // Chinese
// smuggle something cChineseSimplified = cChinese + w.cSimplified; // ChineseSimplified
// smuggle something cChineseTraditional = cChinese + w.cTraditional; // ChineseTraditional
// smuggle something cCzech = b.cCz + b.ce + b.cch; // Czech
// smuggle something cEnglish = b.cEn + b.cgl + p.cish; // English
// smuggle something cFrench = b.cFr + b.cen + b.cch; // French
// // cGerman = b.cGe + b.cr + cman; // German // Defined above in the countries section
// smuggle something cHungarian = w.cHung + b.car + p.cian; // Hungarian
// smuggle something cItalian = b.cIt + b.cal + p.cian; // Italian
// smuggle something cJapanese = cJapan + p.cese; // Japanese
// smuggle something cKorean = b.cKo + b.cre + b.can; // Korean
// smuggle something cMiscellaneous = p.cMis + w.ccell + b.can + p.ceous; // Miscellaneous
// smuggle something cPolish = b.cPo + b.cl + p.cish; // Polish
// smuggle something cPortuguese = w.cPort + b.cug + b.cu + p.cese; // Portuguese
// smuggle something cRussian = b.cRu + b.css + p.cian; // Russian
// smuggle something cSpanish = b.cSp + b.can + p.cish; // Spanish
