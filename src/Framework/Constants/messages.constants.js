...
export const ccommandGeneratorMessage2 = wrd.cAfter + bas.cSpace + wrd.cattempting + bas.cSpace + bas.cto + bas.cSpace + wrd.creplace + bas.cSpace + wrd.cthe + bas.cSpace + wrd.ctertiary + wrd.cCommand + wrd.cDelimiter + bas.cSpace + wrd.cwith + bas.cSpace + wrd.cthe + bas.cSpace + wrd.csecondary + wrd.cCommand + gen.cArs + wrd.cDelimiter + bas.cSpace + wrd.ccommand + wrd.cString + sys.cSpaceIsColonSpace;
