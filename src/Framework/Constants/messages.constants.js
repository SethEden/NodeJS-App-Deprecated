...
export const cresolvedConstantsPath_CommandsIs = wrd.cresolved + wrd.cConstants + wrd.cPath + bas.cUnderscore + wrd.cCommands + sys.cSpaceIsColonSpace; // resolvedConstantsPath_Commands is:
export const cresolvedConstantsPath_ConfigurationsIs = wrd.cresolved + wrd.cConstants + wrd.cPath + bas.cUnderscore + wrd.cConfigurations + sys.cSpaceIsColonSpace; // resolvedConstantsPath_Configurations is:
export const cresolvedConstantsPath_CountriesIs = wrd.cresolved + wrd.cConstants + wrd.cPath + bas.cUnderscore + wrd.cCountries + sys.cSpaceIsColonSpace; // resolvedConstantsPath_Countries Is:
...
export const cresolvedConstantsPath_KnotsIs = wrd.cresolved + wrd.cConstants + wrd.cPath + bas.cUnderscore + wrd.cKnots + sys.cSpaceIsColonSpace; // resolvedConstantsPath_Knots is:
export const cresolvedConstantsPath_LanguagesIs = wrd.cresolved + wrd.cConstants + wrd.cPath + bas.cUnderscore + wrd.cLanguages + sys.cSpaceIsColonSpace; // resolvedConstantsPath_Languages is:
export const cresolvedConstantsPath_MessagesIs = wrd.cresolved + wrd.cConstants + wrd.cPath + bas.cUnderscore + wrd.cMessages + sys.cSpaceIsColonSpace; // resolvedConstantsPath_Messages is:
...
export const cresolvedConstantsPath_PhonicsIs = wrd.cresolved + wrd.cConstants + wrd.cPath + bas.cUnderscore + wrd.cPhonics + sys.cSpaceIsColonSpace; // resolvedConstantsPath_Phonics is:
...
export const cresolvedConstantsPath_UnitsIs = wrd.cresolved + wrd.cConstants + wrd.cPath + bas.cUnderscore + wrd.cUnits + sys.cSpaceIsColonSpace; // resolvedConstantsPath_Units is:
export const cresolvedConstantsPath_WordsIs = wrd.cresolved + wrd.cConstants + wrd.cPath + bas.cUnderscore + wrd.cWords + sys.cSpaceIsColonSpace; // resolvedConstantsPath_Words is:
...
export const cBusinessConstantsPhase1Validation = wrd.cBusiness + bas.cSpace + wrd.Constants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Business Constants Phase 1 Validation
...
export const cCommandsConstantsPhase1Validation = wrd.cCommands + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Commands Constants Phase 1 Validation
export const cConfigurationsConstantsPhase1Validation = wrd.cConfigurations + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Configurations Constants Phase 1 Validation
export const cCountriesConstantsPhase1Validation = wrd.cCountries + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Countries Constants Phase 1 Validation
...
export const cKnotsConstantsPhase1Validation = wrd.cKnots + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Knots Constants Phase 1 Validation
export const cLanguagesConstantsPhase1Validation = wrd.cLanguages + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Languages Constants Phase 1 Validation
export const cMessagesConstantsPhase1Validation = wrd.cMessages + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Messages Constants Phase 1 Validation
...
export const cPhonicsConstantsPhase1Validation = wrd.cPhonics + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Phonics Constants Phase 1 Validation
...
export const cUnitsConstantsPhase1Validation = wrd.cUnits + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Units Constants Phase 1 Validation
...
export const cBusinessConstantsPhase2Validation = wrd.cBusiness + bas.cSpace + wrd.Constants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Business Constants Phase 2 Validation
...
export const cCommandsConstantsPhase2Validation = wrd.cCommands + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Commands Constants Phase 2 Validation
export const cConfigurationsConstantsPhase2Validation = wrd.cConfigurations + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Configurations Constants Phase 2 Validation
export const cCountriesConstantsPhase2Validation = wrd.cCountries + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Countries Constants Phase 2 Validation
...
export const cKnotsConstantsPhase2Validation = wrd.cKnots + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Knots Constants Phase 2 Validation
export const cLanguagesConstantsPhase2Validation = wrd.cLanguages + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Languages Constants Phase 2 Validation
export const cMessagesConstantsPhase2Validation = wrd.cMessages + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Messages Constants Phase 2 Validation
...
export const cPhonicsConstantsPhase2Validation = wrd.cPhonics + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Phonics Constants Phase 2 Validation
...
export const cUnitsConstantsPhase2Validation = wrd.cUnits + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Units Constants Phase 2 Validation
...
export const cConentsOfTheStackNamespace = wrd.cContents + bas.cSpace + bas.cof + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cstack + bas.cSpace + wrd.cnamespace + bas.cColon + bas.cSpace; // Contents of the stack namespace:
