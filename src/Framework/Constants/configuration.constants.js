 ...
 * @description Contains many re-usable configuration constants.
...
export const cEnableDebugConfigurationSettings = wrd.cEnable + wrd.cDebug + wrd.cConfiguration + wrd.cSettings; // EnableDebugConfigurationSettings
