...
//////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
export const ctan = b.cta + b.cn;
export const cstan = b.cs + ctan;
export const cistan = cist + b.can;
export const cnistan = b.cn + cistan;
export const cnia = b.cni + b.ca;
export const cania = b.ca + cnia;
export const cria = b.cri + b.ca;
export const ceria = b.ce + cria;
export const cgeria = cger + b.cia;
export const crra = b.crr + b.ca;
export const cola = b.col + b.ca;
export const cgua = b.cgu + b.ca;
export const cina = b.cin + b.ca;
export const cenia = b.cen + b.cia;
export const clia = b.cli + b.ca;
export const calia = b.ca + clia;
export const crain = b.cra + b.cin;
export const cuda = b.cud + b.ca;
export const crus = b.cru + b.cs;
export const cvia = b.cvi + b.ca;
export const cndi = b.cnd + b.ci;
export const cdia = b.cdi + b.ca;
export const cada = b.ca + b.cd + b.ca;
export const cnada = b.cn + cada;
export const clic = b.cli + b.cc;
export const cblic = b.cb + clic;
export const cublic = b.cu + cblic;
export const cbia = b.cbi + b.ca;
export const cmbia = b.cm + cbia;
export const cngo = b.cng + b.co;
export const congo = b.co + cngo;
export const cica = b.cic + b.ca;
export const cnica = b.cn + cica;
export const cinica = b.cin + cica;
export const cminica = b.cm + b.ci + cnica;
export const cominica = b.co + cminica;
export const cador = b.ca + b.cd + b.cor;
export const cdor = b.cdo + b.cr;
export const cnea = b.cne + b.ca;
export const cinea = cine + b.ca;
export const cuinea = b.cu + cinea;
export const conia = b.con + b.cia;
export const cini = b.cin + b.ci;
export const cnce = b.cnc + b.ce;
export const cambia = b.cam + b.cbi + b.ca;
export const cerman = cerm + b.can;
export const crman = b.crm + b.can;
export const cala = b.cal + b.ca;
export const citi = b.cit + b.ci;
export const celand = b.cel + cand;
export const csia = b.csi + b.ca;
export const cesia = b.ce + csia;
export const cnesia = b.cn + cesia;
export const conesia = b.co + cnesia;
export const cran = b.cra + b.cn;
export const cdan = b.cda + b.cn;
export const cati = b.cat + b.ci;
export const ccar = b.cca + b.cr;
export const cali = b.cal + b.ci;
export const cslands = b.csl + cand + b.cs;
export const cands = cand + b.cs;
export const cnds = b.cnd + b.cs;
export const cova = b.cov + b.ca;
export const cnmar = b.cnm + b.car;
export const cmar = b.cma + b.cr;
export const curu = b.cur + b.cu;
export const cagua = b.cag + b.cua;
export const cragua = b.cr + cagua;
export const caragua = cara + b.cgu + b.ca;
export const ciger = b.cig + b.cer;
export const corea = core + b.ca;
export const ckistan = b.cki + b.cst + b.can;
export const cama = b.cam + b.ca;
export const cguay = b.cgu + b.cay;
export const cuay = b.cua + b.cy;
export const cnes = b.cne + b.cs;
export const cgal = b.cga + b.cl;
export const cnda = b.cnd + b.ca;
export const canda = cand + b.ca;
export const cles = b.cle + b.cs;
export const crica = cric + b.ca;
export const cfrica = b.cf + crica;
export const cudan = b.cud + b.can;
export const crland = b.crl + cand;
export const cerland = b.ce + crland;
export const cste = b.cst + b.ce;
export const cnga = b.cng + b.ca;
export const cates = cate + b.cs;
export const ctes = b.cte + b.cs;
export const cela = b.cel + b.ca;
export const cnam = b.cna + b.cm;
export const cmen = b.cme + b.cn;
