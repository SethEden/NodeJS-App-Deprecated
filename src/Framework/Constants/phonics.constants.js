...
export const cass = b.ca + b.css;
export const cind = b.cin + b.cd;
export const clin = b.cli + b.cn;
export const cLin = b.cLi + b.cn;
export const ccom = b.cco + b.cm;
export const cCom = b.cCo + b.cm;
export const cubic = b.cub + b.cic;
export const cane = b.can + b.ce;
export const curve = b.cur + b.cve;
export const cqua = b.cqu + b.ca;
export const cQua = b.cQu + b.ca;
export const crtic = b.crt + b.cic;
export const csec = b.cse + b.cc;
export const cSec = b.cSe + b.cc;
export const cuni = b.cun + b.ci;
export const cUni = b.cUn + b.ci;
export const chyper = b.chy + cper;
export const cHyper = b.cHy + cper;
export const cbola = b.cbo + b.cla;
