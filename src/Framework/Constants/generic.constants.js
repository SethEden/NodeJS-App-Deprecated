...
export const cDotexe = b.cDot + cexe; // .exe
export const cDotExe = b.cDot + cExe; // .Exe
export const cDotEXE = b.cDot + cEXE; // .EXE
...
export const cDotXml = b.cDot + cXml; // .Xml
export const cDotXML = b.cDot + cXML; // .XML
export const cDotlog = b.cDot + clog; // .log
export const cDotLog = b.cDot + cLog; // .Log
export const cDotLOG = b.cDot + cLOG; // .LOG
...
// Miscelanious
export const cUTF8 = b.cUT + b.cF + n.c8; // UTF8
...
export const cRegEx = p.cReg + b.cEx; // RegEx
export const cregExp = cregEx + b.cp; // regExp
export const cRegExp = cRegEx + b.cp; // RegExp
