...
export const cBurundi = bas.cBu + bas.crun + bas.cdi; // Burundi
...
export const cDemocraticRepublicOfTheCongo = wrd.cDemocratic + bas.cSpace + wrd.cRepublic + bas.cSpace + bas.cof + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cCongo; // Democratic Republic of the Congo
...
export const cPapuaNewGuinea = wrd.cPapua + bas.cSpace + wrd.cNew + bas.cSpace + wrd.cGuinea; // Papua New Guinea
...
export const cUnitedStatesOfAmerica = wrd.cUnited + bas.cSpace + wrd.cStates + bas.cSpace + bas.cof + bas.cSpace + wrd.cAmerica; // United States Of Ammerica
