...
export const cHungarian = cHung + bas.car + phn.cian; // Hungarian
export const cItalian = bas.cIt + bas.cal + phn.cian; // Italian
export const cJapanese = cJapan + phn.cese; // Japanese
export const cKorean = bas.cKo + bas.cre + bas.can; // Korean
export const cMiscellaneous = phn.cMis + ccell + bas.can + phn.ceous; // Miscellaneous
export const cPolish = bas.cPo + bas.cl + phn.cish; // Polish
export const cPortuguese = cPort + bas.cug + bas.cu + phn.cese; // Portuguese
