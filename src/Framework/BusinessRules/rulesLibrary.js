...
export const initRulesLibrary = function() {
  ...
  D[s.cBusinessRules] = {
    ...
    [s.cgetWordsArrayFromString]: (inputData, inputMetaData) => stringParsing.getWordsArrayFromString(inputData, inputMetaData),
    [s.crecombineStringArrayWithSpaces]: (inputData, inputMetaData) => stringParsing.recombineStringArrayWithSpaces(inputData, inputMetaData),
    ...
    [s.cascertainMatchingElements]: (inputData, inputMetaData) => stringParsing.acertainMatchingElements(inputData, inputMetaData),
    [s.cdoesArrayContainFilename]: (inputData, inputMetaData) => stringParsing.doesArrayContainFilename(inputData, inputMetaData),
    [s.cgetLengthOfLongestStringInArray]: (inputData, inputMetaData) => stringParsing.getLengthOfLongestStringInArray(inputData, inputMetaData),
    [s.csearchForPatternsInStringArray]: (inputData, inputMetaData) => stringParsing.searchForPatternsInStringArray(inputData, inputMetaData),
    [s.cvalidatePatternsThatNeedImplementation]: (inputData, inputMetaData) => stringParsing.validatePatternsThatNeedImplementation(inputData, inputMetaData),
    ...
    [s.cisArrayEmpty]: (inputData, inputMetaData) => stringParsing.isArrayEmpty(inputData, inputMetaData),
    [s.cisObject]: (inputData, inputMetaData) => stringParsing.isObject(inputData, inputMetaData),
    [s.cisArray]: (inputData, inputMetaData) => stringParsing.isArray(inputData, inputMetaData),
    [s.cisArrayOrObject]: (inputData, inputMetaData) => stringParsing.isArrayOrObject(inputData, inputMetaData),
    [s.cisNonZeroLengthArray]: (inputData, inputMetaData) => stringParsing.isNonZeroLengthArray(inputData, inputMetaData),
    [s.carrayDeepClone]: (inputData, inputMetaData) => stringParsing.arrayDeepClone(inputData, inputMetaData),
