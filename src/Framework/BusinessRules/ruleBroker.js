...
function addClientRules(clientRules) {
  ...
  // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'clientRules is: ' + JSON.stringify(clientRules));
...
export const processRules = function(inputData, inputMetaData, rulesToExecute) {
  ...
  // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, sys.cBEGIN_Function);
  // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, sys.cinputDataIs + inputData);
  // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, sys.cinputMetaDataIs + inputMetaData);
  let returnData = inputData;
  for (let rule in rulesToExecute) {
    if (rulesToExecute.hasOwnProperty(rule)) {
      let key = rule;
      // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'key is: ' + key);
  ...
  // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, sys.creturnDataIs + returnData);
  // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, sys.cEND_Function);
