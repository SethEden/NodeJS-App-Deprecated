...
export const randomlyGenerateEitherMixedCaseLetterOrNumberOrSpecialCharacter1 = function(inputData, inputMetaData) {
  ...
  // typeToGenerate is:
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cCharacterGenerationMessage1 + typeToGenerate);
  switch (typeToGenerate) {
    case 1: case num.c1: // Generate a number.
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cCharacterGenerationMessage2);
    ...
    case 2: case num.c2: // Generate a random upper case or lower case letter.
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cCharacterGenerationMessage3);
      returnData = randomlyGenerateMixedCaseAlphabeticCharacter1(inputData, inputMetaData);
      break;
    case 3: case num.c3:// Generate a special character.
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cCharacterGenerationMessage4);
      returnData = randomlyGenerateSpecialCharacter1(inputData, inputMetaData);
      break;
    default: // DEFAULT: Generate a random upper case or lower case letter.
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cCharacterGenerationMessage5);
      returnData = randomlyGenerateMixedCaseAlphabeticCharacter1(inputData, inputMetaData);
      break;
  }
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataIs + returnData);
