...
export const getWordsArrayFromString = function(inputData, inputMetaData) {
  ...
  if (inputData) {
    ...
    if (wordCount > 0) {
      ...
      // wordDelimiter is:
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cwordDelimiterIs + wordDelimiter);
      let stringContainsAcronym = strParse.doesStringContainAcronym(inputData, '');
      // stringContainsAcronym is:
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cstringContainsAcronymIs + stringContainsAcronym);
      if (wordDelimiter === sys.cCamelCase && stringContainsAcronym === false) {
        ...
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cGetWordsArrayFromStringMessage1 + msg.cGetWordsArrayFromStringMessage2 + msg.cGetWordsArrayFromStringMessage3);
      }
    }
  }
...
export const doesArrayContainLowerCaseConsolidatedString = function(inputData, inputMetaData) {
  ...
  if (inputData && inputMetaData) {
    ...
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cstringDeltaValueIs + stringDelta);
...
export const ascertainMatchingElements = function(inputData, inputMetaData) {
  ...
  if (inputData && inputMetaData) {
    if (inputData === inputMetaData) {
      ...
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cArrayElementsMatch);
      returnData = true;
    } else {
      // Array elements do not match
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cArrayElementsDoNotMatch);
      returnData = false;
    }
  }
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataIs + returnData);
...
export const searchForPatternsInStringArray = function(inputData, inputMetaData) {
  ...
  if (inputData && inputData.length > 0) {
    ...
    // maxStringLength is:
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cmaxStringLengthIs + maxStringLength);
    let minStringLength = 3;
    // minStringLength is:
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cminStringLengthIs + minStringLength);
    for (let a = 0; a < inputData.length; a++) { // Initial high-level loop over each of the array elements. (This is the source string for the comparison)
      ...
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.ccurrentMasterStringArrayElementIs + currentMasterStringArrayElement);
      if (currentMasterStringArrayElement.includes(bas.cSpace) === false) {
        ...
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cSearchForPatternsInStringArrayMessage1);
        ...
        for (let b = minStringLength; b <= maxStringLength; b++) { // b will now hold the length of the string we are using to compare.
          // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'length of string to compare is: ' + toString(b));
          ...
          if (currentMasterStringArrayElement.length <= b) {
            // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'currentMasterStringArrayElement.length is less than b');
            ...
            for (let c = 0; c <= currentMasterStringArrayElement.length - minStringLength; c++) { // loop through each set of strings in the master comparison string.
              // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'c value is: ' + c);
              ...
              // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'beginningIndex is: ' + beginningIndex);
              // console.log('beginningIndex is: ' + beginningIndex);
              let endingIndex = c + b;
              // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'endingIndex is: ' + endingIndex);
              ...
              // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'stringToCompare is: ' + stringToCompare);
              ...
              for (let d = 0; d < inputData.length; d++) {
                // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'd value is: ' + d);
                // console.log('d value is: ' + d);
                if (d != a) {
                  // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'd != a');
                  // console.log('d != a');
                  let otherStringToCompare = inputData[d];
                  // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'otherStringToCompare is: ' + otherStringToCompare);
                  // console.log('otherStringToCompare is: ' + otherStringToCompare);
                  if (otherStringToCompare.includes(stringToCompare)) {
                    // loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'FOUND A MATCH!!!!');
        ...
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cSearchForPatternsInStringArrayMessage2 + msg.cSearchForPatternsInStringArrayMessage3);
      }
    ...
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cSearchForPatternsInStringArrayMessage4);
  }
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataIs + JSON.stringify(returnData));
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cEND_Function);
  return returnData;
  ...
  if (inputData) {
    ...
    for (let i = 0; i < inputData.length; i++) {
      ...
      if (strParse.doesConstantExist(currentString, '') === false) {
        ...
        // constant does NOT exist:
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cConstantDoesNotExist + currentString);
        ...
        console.log(passMessage);
        // constant does exist:
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cConstantDoesExist + currentString);
      }
    }
  }
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataIs + JSON.stringify(returnData));
...
export const solveLehmerCode = function(inputData, inputMetaData) {
  ...
  if (inputData) {
    ...
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cexpandedLehmerCodeArrayIs + JSON.stringify(expandedLehmerCodeArray));
...
export const recursiveArrayExpansion = function(inputData, inputMetaData) {
  ...
  if (inputData && inputMetaData && isArray(inputData) === true && isArray(inputMetaData) === true && inputData.length > 0 && inputMetaData.length > 0) {
    ...
    // indexOfExpansion is:
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cindexOfExpansionIs + indexOfExpansion);
    // arrayToBeExpanded is:
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.carrayToBeExpandedIs + JSON.stringify(arrayToBeExpanded));
    // limitOfExpansion is:
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.climitOfExpansionIs + limitOfExpansion);
    ...
    for (let i = 0; i <= limitOfExpansion; i++) {
      ...
      if (doesArrayContainValue(returnData, lehmerCodeArray1, ascertainMatchingElements) === false) {
        ...
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cpushingLehmerCodeArray1ToReturnDataValue + JSON.stringify(lehmerCodeArray1));
        returnData.push(lehmerCodeArray1);
        // returnData after push is:
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataAfterPushIs + JSON.stringify(returnData));
      }
    }
    // returnData after Level 1 is:
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataAfterLevel1Is + JSON.stringify(returnData));
    ...
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.carrayToBeExpandedDotLengthIs + arrayToBeExpanded.length);
    if (indexOfExpansion < arrayToBeExpanded.length - 1) {
      ...
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataDotLengthIs + returnData.length);
      ...
      returnDataTemp.forEach(function(item) {
        ...
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataBeforePopIs + JSON.stringify(returnData));
        let lehmerCodeArray2 = arrayDeepClone(returnData.pop(), '');
        // returnData AFTER POP is:
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataAfterPopIs + JSON.stringify(returnData));
        // masterTempReturnData BEFORE recursive call is:
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cmasterTempReturnDataBeforeRecursiveCallIs + JSON.stringify(masterTempReturnData));
        let tempReturnData1 = arrayDeepClone(recursiveArrayExpansion([indexOfExpansion + 1, lehmerCodeArray2], inputMetaData), '');
        // tempReturnData1 is:
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.ctempReturnData1Is + JSON.stringify(tempReturnData1));
        // tempReturnData1.length is:
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.ctempReturnData1DotLengthIs + tempReturnData1.length);
        for (let k = 0; k <= tempReturnData1.length - 1; k++) {
          // BEGIN k-th iteration:
          loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cBEGIN_kthIteration + k);
          if (doesArrayContainValue(masterTempReturnData, tempReturnData1[k], ascertainMatchingElements) === false) {
            ...
            loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cpushingTempReturnData1Kvalue + JSON.stringify(tempReturnData1[k]));
            masterTempReturnData.push(arrayDeepClone(tempReturnData1[k], ''));
          }
          // END k-th iteration:
          loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cEND_kthIteration + k);
        }
        tempReturnData1 = null;
        // masterTempReturnData AFTER recursive call is:
        loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cmasterTempReturnDataAfterRecursiveCallIs + JSON.stringify(masterTempReturnData));
      });
...
export const getLehmerCodeValue = function(inputData, inputMetaData) {
  ...
  if (inputData) {
    ...
    for (let i = 0; i < lengthOfInputData; i++) {
      ...
      // lookupIndex is:
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.clookupIndexIs + lookupIndex);
      let lookupValue = inputMetaData[i][lookupIndex]
      // lookupValue is:
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.clookupValueIs + lookupValue);
...
export const generateCommandAliases = function(inputData, inputMetaData) {
  ...
  if (inputData) {
    ...
    // commandWordsKeys1.forEach((key1) => {
      ...
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.ccommandWordAliasesBeforeChangeIs + commandWordAliases);
      ...
      loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.ccommandWordAliasesAfterChangeIs + JSON.stringify(commandWordAliasesArray));
    ...
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cmasterCommandWordAlisesArrayIs + JSON.stringify(masterCommandWordAliasesArray));
    // masterArrayIndex is:
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cmasterArrayIndexIs + JSON.stringify(masterArrayIndex));
...
export const getFileAndPathListForPath = function(inputData, inputMetaData) {
  ...
  if (inputData) {
    ...
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, 'filesListLimit is: ' + filesListLimit);
...
function doesArrayContainValue(array, value, myFunction) {
  ...
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cBEGIN_Function);
  // array is:
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.carrayIs + JSON.stringify(array));
  // value is:
  ...
  // myFunction is:
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cmyFunctionIs + JSON.stringify(myFunction));
  let returnData = false;
  if (_.isArray(array) === false) {
    // array input object is not an array.'
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.carrayInputObjectIsNotAnArray);
    returnData = false;
  }
  if (!!array.find(i => myFunction(i, value))) {
    // The value was found in the array.
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cTheValueWasFoundInTheArray);
    returnData = true;
  } else {
    // The value was NOT found in the array.
    loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cTheValueWasNotFoundInTheArray);
    returnData = false;
  }
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.creturnDataIs + returnData);
  loggers.consoleLog(namespacePrefix + baseFileName + bas.cDot + functionName, msg.cEND_Function);
