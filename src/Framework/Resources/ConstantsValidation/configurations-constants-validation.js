/**
 * @file configurations-constants-validation.js
 * @module configurations-constants-validation
...
import * as cfg from '../../Constants/configurations.constants';
 ...
 /**
 * @function configurationsConstantsValidation
 * @description Initializes the configurations constants validation data objects array.
 * @return {void}
 * @author Seth Hollingsead
 * @date 2021/02/17
 */
 export const configurationsConstantsValidation = [
