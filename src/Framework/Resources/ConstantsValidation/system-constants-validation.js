...
export const systemConstantsValidation = [
   ...
   {Name: 'cDebugFunctions', Actual: sys.cDebugFunctions, Expected: 'DebugFunctions'},
   {Name: 'cDebugFiles', Actual: sys.cDebugFiles, Expected: 'DebugFiles'},
   ...
   {Name: 'cLogFilePathAndName', Actual: sys.cLogFilePathAndName, Expected: 'LogFilePathAndName'},
   {Name: 'cDataLogFilePathAndName', Actual: sys.cDataLogFilePathAndName, Expected: 'DataLogFilePathAndName'},
   {Name: 'cExecutionJournalFilePathAndName', Actual: sys.cExecutionJournalFilePathAndName, Expected: 'ExecutionJournalFilePathAndName'},
   {Name: 'cResultsLogFilePathAndName', Actual: sys.cResultsLogFilePathAndName, Expected: 'ResultsLogFilePathAndName'},
   {Name: 'cTestDataPath', Actual: sys.cTestDataPath, Expected: 'TestDataPath'},
   {Name: 'cLogFileEnabled', Actual: sys.cLogFileEnabled, Expected: 'LogFileEnabled'},
   {Name: 'cIncludeDateTimeStampInLogFiles', Actual: sys.cIncludeDateTimeStampInLogFiles, Expected: 'IncludeDateTimeStampInLogFiles'},
   ...
   {Name: 'cConstantsPath', Actual: sys.cConstantsPath, Expected: 'ConstantsPath'},
   {Name: 'cConstantsPathActual', Actual: sys.cConstantsPathActual, Expected: 'src/Framework/Constants/'},
   ...
   {Name: 'cUnitsConstantsValidation', Actual: sys.cUnitsConstantsValidation, Expected: 'UnitsConstantsValidation'},
