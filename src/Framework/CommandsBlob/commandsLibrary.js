...
export const initCommandsLibrary = function() {
  ...
  D[w.cCommands] = {
    ...
    [w.cdeployApplication]: (inputData, inputMetaData) => nominalCommands.deployApplication(inputData, inputMetaData),
    [w.creleaseApplication]: (inputData, inputMetaData) => nominalCommands.releaseApplication(inputData, inputMetaData),
